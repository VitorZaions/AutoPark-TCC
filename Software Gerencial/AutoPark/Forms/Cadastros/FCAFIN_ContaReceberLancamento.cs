...
{
    public partial class FCAFIN_ContaReceberLancamento : MetroForm
    {
        ...
        public FCAFIN_ContaReceberLancamento(decimal? Valor, string Origem, decimal? IDEntrada)
        {
            InitializeComponent();
            //_Valor = valor;
        ...
        private void PreencherTela()
        {
            ...
            if (_Origem.Contains("Entrada") || _Origem.Contains("Saida"))
            {
            ...
            try
            {
                ...
                foreach (DataRow dr in DUPLICATAS.Rows)
                {
                    ...
                    if (!FuncoesContaReceber.Salvar(new ContaReceber()
                    {
                        ...
                        IDCliente = CLIENTE != null ? CLIENTE.IDCliente : null,
                        Juros = 0,
                        Multa = 0,
                        ...
                        IDEntrada = _IDEntrada == null ? null : _IDEntrada.Value    
                    }, TipoOperacao.INSERT))
